...
<body>
	...
	<div class="container my-3">
		<div class="d-flex py-3"><h3>Total Price:  ${(total>0)?dcf.format(total):0} Birr </h3> <a class="mx-3 btn btn-primary" href="cart-check-out">Check Out</a></div>
